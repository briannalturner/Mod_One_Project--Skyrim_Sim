...
### INTERACTIONS ###
### markarth ###
kill_vorstag = Interaction.find_or_create_by(description: "You slice Vorstag cleanly through the chest with your blade.", npc_id: vorstag.id, bounty: 1000, town_id: markarth.id, action_name: "Kill")
...
kill_markarth_jarl = Interaction.find_or_create_by(description: "You destroy Jarl Igmund's torso with a firebolt spell.", npc_id: markarth_jarl.id, bounty: 1000, town_id: markarth.id, action_name: "Kill")
...
kill_calcelmo = Interaction.find_or_create_by(description: "You cleave Calcelmo's head in two with your sword.", npc_id: calcelmo.id, bounty: 1000, town_id: markarth.id, action_name: "Kill")
...
### dawnstar ###
kill_wayfinder = Interaction.find_or_create_by(description: "You slice Captain Wayfinder cleanly through the chest with your blade.", npc_id: capt_wayfinder.id, bounty: 1000, town_id: dawnstar.id, action_name: "Kill")
...
kill_dawnstar_jarl = Interaction.find_or_create_by(description: "You destroy Jarl Skald the Elder's torso with a firebolt spell.", npc_id: dawnstar_jarl.id, bounty: 1000, town_id: dawnstar.id, action_name: "Kill")
...
kill_alesan = Interaction.find_or_create_by(description: "You seriously tried to kill a kid? You're sick.", npc_id: alesan.id, bounty: 1000, town_id: dawnstar.id, action_name: "Kill")
...
### morthal ###
kill_lami = Interaction.find_or_create_by(description: "You slice Lami cleanly through the chest with your blade.", npc_id: lami.id, bounty: 1000, town_id: morthal.id, action_name: "Kill")
...
kill_morthal_jarl = Interaction.find_or_create_by(description: "You destroy Jarl Idgrod Ravencrone's torso with a firebolt spell.", npc_id: morthal_jarl.id, bounty: 1000, town_id: morthal.id, action_name: "Kill")
...
kill_lurbuk = Interaction.find_or_create_by(description: "You cleave Lurbuk's head in two with your sword.", npc_id: lurbuk.id, bounty: 1000, town_id: morthal.id, action_name: "Kill")
...
### solitude ###
kill_dervenin = Interaction.find_or_create_by(description: "You slice Dervenin cleanly through the chest with your blade.", npc_id: dervenin.id, bounty: 1000, town_id: solitude.id, action_name: "Kill")
...
kill_solitude_jarl = Interaction.find_or_create_by(description: "You destroy Jarl Elisif the Fair's torso with a firebolt spell.", npc_id: solitude_jarl.id, bounty: 1000, town_id: solitude.id, action_name: "Kill")
...
kill_svari = Interaction.find_or_create_by(description: "You seriously tried to kill a kid? You're sick.", npc_id: svari.id, bounty: 1000, town_id: solitude.id, action_name: "Kill")
...
### Riften Interactions ###
kill_riften_jarl = Interaction.find_or_create_by(description: "You eviscerate the Jarl Laila Law-Giver's neck with one swipe of your sword.", npc_id: riften_jarl.id, bounty: 1000, town_id: riften.id, action_name: "Kill")
...
kill_edda = Interaction.find_or_create_by(description: "You straight up kill her.", npc_id: edda.id, goodwill: 0, town_id: riften.id, action_name: "Kill")
...
kill_maven = Interaction.find_or_create_by(description: "You assasinate Maven Black Briar... you cause havoc in all of Riften", bounty: 1000, goodwill: 0, npc_id: maven.id, town_id: riften.id, action_name: "Kill")
...
kill_jarl = Interaction.find_or_create_by(description: "You kill Ulfric with your Shout... Karma", goodwill: 0, bounty: 1000, npc_id: windhelm_jarl.id, town_id: windhelm.id, action_name: "Kill")
kill_calixto = Interaction.find_or_create_by(description: "You cleave Calixto's head in two with your sword.", npc_id: calixto_corrium.id, town_id: windhelm.id, action_name: "Kill")
...
kill_savos_aren = Interaction.find_or_create_by(description: "You slice Savos Aren cleanly through the chest with your blade.", npc_id: savos_aren.id, bounty: 1000, town_id: winterhold.id, action_name: "Kill")
...
kill_winterhold_jarl = Interaction.find_or_create_by(description: "You destroy Jarl Korir's torso with a firebolt spell.", npc_id: winterhold_jarl.id, bounty: 1000, town_id: winterhold.id, action_name: "Kill")
...
kill_ancano = Interaction.find_or_create_by(description: "You cleave Ancano's head in two with your sword.", npc_id: ancano.id, bounty: 1000, town_id: winterhold.id, action_name: "Kill")
...
kill_heimskr = Interaction.find_or_create_by(description: "You slice Heimskr cleanly through the chest with your blade.", npc_id: heimskr.id, bounty: 1000, town_id: whiterun.id, action_name: "Kill")
...
kill_whiterun_jarl = Interaction.find_or_create_by(description: "You destroy Jarl Balgruuf the Greater's torso with a firebolt spell.", npc_id: whiterun_jarl.id, bounty: 1000, town_id: whiterun.id, action_name: "Kill")
...
kill_nazeem = Interaction.find_or_create_by(description: "You cleave Nazeem's head in two with your sword.", npc_id: nazeem.id, bounty: 1000, town_id: whiterun.id, action_name: "Kill")
...
kill_sinding = Interaction.find_or_create_by(description: "You eviscerate Sinding's neck with one swipe of your sword.", npc_id: sinding.id, goodwill: 100, town_id: falkreath.id, action_name: "Kill")
